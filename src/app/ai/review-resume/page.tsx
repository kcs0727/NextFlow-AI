...
export default function ReviewResume() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-full text-slate-705 dark:text-slate-350">
      ...
      >
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-slate-800 dark:text-slate-100">Resume Review</h1>
          </div>

          <div className="mt-6">
            <label className="text-sm font-semibold text-slate-650 dark:text-slate-400">Upload Resume (Max 5MB)</label>
            <div className="mt-2 flex items-center justify-center w-full">
              <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl cursor-pointer bg-slate-50 dark:bg-slate-950 hover:bg-slate-100/50 dark:hover:bg-slate-900/50 transition">
                <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                  ...
                  <p className="text-xs font-semibold text-slate-505 dark:text-slate-450">
        ...
        <button 
          type="submit" 
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-teal-600 to-emerald-500 hover:from-teal-700 hover:to-emerald-600 text-white px-5 py-3 mt-8 text-sm font-semibold rounded-xl cursor-pointer shadow-md shadow-teal-500/10 hover:shadow-lg disabled:opacity-50 transition" 
      ...
      <div className="flex-1 p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col min-h-[400px]">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-100 dark:border-slate-800/60">
          ...
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Analysis Results</h2>
        </div>
