...
export default function WriteArticle() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-full text-slate-700 dark:text-slate-300">
      ...
      >
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-slate-800 dark:text-slate-100">Article Configuration</h1>
          </div>

          <div className="mt-6">
            <label className="text-sm font-semibold text-slate-600 dark:text-slate-400">Article Topic</label>
            <input 
              type="text" 
              className="w-full p-3 mt-2 outline-none text-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition duration-200"
          ...
          <div className="mt-6">
            <label className="text-sm font-semibold text-slate-600 dark:text-slate-400">Article Length</label>
                ...
                <span 
                  ...
                  className={`text-xs px-4 py-2 border rounded-full cursor-pointer transition font-medium
                    ${selectedLen.text === item.text 
                      ? 'bg-blue-50 border-blue-300 text-blue-600 dark:bg-blue-950/35 dark:border-blue-900/50 dark:text-blue-450 font-bold' 
        ...
        <button 
          type="submit" 
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-450 hover:from-blue-700 hover:to-blue-500 text-white px-5 py-3 mt-8 text-sm font-semibold rounded-xl cursor-pointer shadow-md shadow-blue-500/10 hover:shadow-lg disabled:opacity-50 transition" 
      ...
      <div className="flex-1 p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col min-h-[400px]">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-100 dark:border-slate-800/60">
          ...
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Generated Article</h2>
        </div>
        ...
        {!content ? (
          ...
          <div className="flex-1 overflow-y-auto mt-4 pr-2 text-sm leading-relaxed text-slate-650 dark:text-slate-350 prose dark:prose-invert max-w-none">
