...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col h-full gap-6">
      ...
      <div>
        <h1 className="text-2xl font-bold font-sans text-slate-800 dark:text-slate-100">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Total Creations */}
        <div className="flex justify-between items-center py-5 px-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm transition">
          <div>
            <p className="text-xs font-semibold text-slate-405 dark:text-slate-500 uppercase tracking-wider">Total Creations</p>
            <h2 className="text-3xl font-extrabold text-slate-800 dark:text-slate-150 mt-1">{creations.length}</h2>
          </div>
        ...
        <div className="flex justify-between items-center py-5 px-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm transition">
          <div>
            <p className="text-xs font-semibold text-slate-405 dark:text-slate-500 uppercase tracking-wider">Active Plan</p>
            <h2 className="text-3xl font-extrabold text-slate-800 dark:text-slate-150 mt-1">
        ...
        <div className="flex justify-between items-center py-5 px-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm transition">
          <div>
            <p className="text-xs font-semibold text-slate-405 dark:text-slate-500 uppercase tracking-wider">API Usage Tier</p>
            <h2 className="text-lg font-bold text-slate-805 dark:text-slate-200 mt-2">
      ...
      <div className="flex-1 flex flex-col min-h-[300px]">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-bold text-slate-850 dark:text-slate-200 font-sans">Recent Generations</h3>
          <select
            value={filter}
            onChange={(e) => setFilter(e.target.value)}
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-1.5 text-sm text-slate-700 dark:text-slate-350 focus:outline-none focus:ring-2 focus:ring-blue-500/25 transition cursor-pointer"
          >
        ...
        {loading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center border border-dashed border-slate-200 dark:border-slate-800/80 rounded-2xl p-10 bg-white dark:bg-slate-950/20 text-center min-h-[250px]">
            <FolderOpen className="w-12 h-12 text-slate-300 dark:text-slate-700 mb-4" />
            <h4 className="font-bold text-slate-800 dark:text-slate-200 mb-1">No creations found</h4>
