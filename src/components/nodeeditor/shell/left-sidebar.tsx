    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <div className="mb-4 space-y-1 px-1">
                    ...
                    <button
                        ...
                        className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left text-sm font-semibold text-slate2 transition-colors hover:bg-slate8 disabled:opacity-40"
                ...
                {!collapsed ? (
                    <div className="mb-6 rounded-xl border border-slateb bg-slate9 px-3 py-2">
                        <div className="flex items-center gap-2 text-slate5">
                ...
                <div className="space-y-1">
                    {!collapsed ? <p className="mb-4 px-2 text-[11px] uppercase tracking-[0.2em] text-slate5">Quick Access</p> : null}
            ...
            <div className="mt-auto px-1 pt-4">
                {userId ? (
                    <div className="flex items-center gap-3 rounded-lg hover:bg-slate8 px-2 py-2">
                        <UserButton />
                        {!collapsed ? <span className="max-w-36.25 truncate text-sm font-semibold text-slate2">{displayName}</span> : null}
                    </div>
                ) : (
                    <SignInButton mode="modal">
                        <button className="flex w-full items-center gap-3 rounded-xl border border-slateb bg-slate9 px-3 py-2 text-left text-sm font-semibold text-slate2 transition-colors hover:bg-slate8">
                            <span className="block h-4 w-4 rounded-full border border-slate5" />
