        ...
        <NodeShell title={typedData.title} status={typedData.status} error={typedData.error} selected={selected}>
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <NumberField label="Width %" keyName="width_percent" data={typedData} id={id} placeholder="100" />
                    <NumberField label="Height %" keyName="height_percent" data={typedData} id={id} placeholder="100" />
                </div>

                {/* Info */}
                <p className="text-[11px] text-slate5">Crop area: 0-100% for each parameter</p>
