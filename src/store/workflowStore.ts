...
import { createNode, createEdge } from "@/lib/workflow/node-factory";
import { upstreamSubgraph, validateConnection } from "@/lib/workflow/graph";
import type {
  HistoryScope,
  WorkflowEdge,
  WorkflowNode,
...
type WorkflowState = {
  ...
  undoStack: Snapshot[];
  redoStack: Snapshot[];
  // Trigger / run history (merged from triggerStore)
...
export const useWorkflowStore = create<WorkflowState>((set, get) => ({
  ...
  // Trigger / run history actions (merged from triggerStore)
  addRunHistory: (entry) =>
